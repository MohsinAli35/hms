                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="department_id" class="form-control">
                                            ...
                                            @if ($dept->id == $patients->department_id)
                                            <option value="{{ $dept->id }}" {{ $dept->id == $patients->department_id ? 'selected' : '' }}>{{ $dept->id == $patients->department_id ? 'selected' : '' }}-{{ $dept->name }}</option>
                                ...
                                <div class="col-sm-6">
									<div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" class="form-check-input"value="2" {{$patients->gender == '3' ? 'checked' :''}}>Transgender
											</label>
